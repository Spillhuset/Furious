...
public class EnderseeCommand implements CommandInterface, CommandExecutor, TabCompleter {
    private final Furious plugin;

    public EnderseeCommand(Furious plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String[] args) {
        ...
        Components.sendSuccess(sender, Components.t("Opened ender chest of "), Components.playerComp(target.getName()), Components.t("."));
        return true;
    }
    ...
    @Override
    public String getName() { return "endersee"; }

    @Override
    public String getPermission() { return "furious.endersee"; }
}
