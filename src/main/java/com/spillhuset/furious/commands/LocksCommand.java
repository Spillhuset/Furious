...
import com.spillhuset.furious.commands.LocksCommands.LockSub;
import com.spillhuset.furious.commands.LocksCommands.UnlockSub;
...
public class LocksCommand implements CommandInterface, CommandExecutor, TabCompleter {
    ...
    public LocksCommand(Furious plugin) {
        ...
        subCommands.addAll(Arrays.asList(
                new LockSub(this.plugin),
                new UnlockSub(this.plugin),
                new com.spillhuset.furious.commands.LocksCommands.KeySub(this.plugin),
                new com.spillhuset.furious.commands.LocksCommands.WorldsCommand(this.plugin)
        ));
    }
