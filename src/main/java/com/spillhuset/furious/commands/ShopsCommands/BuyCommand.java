...
public class BuyCommand implements SubCommandInterface {
    ...
    public BuyCommand(Furious plugin) { this.plugin = plugin; }
    ...
    public boolean execute(CommandSender sender, String[] args) {
        ...
        if (args.length < 4) {
            Components.sendInfoMessage(sender, "Usage: /shops buy <shop> <material> <amount>");
            return true;
        }
        String shop = args[1];
        String mat = args[2];
        ...
        plugin.shopsService.buy(player, shop, mat, amount);
        return true;
    }
    ...
    @Override
    public String getPermission() { return "furious.shops.buy"; }
}
