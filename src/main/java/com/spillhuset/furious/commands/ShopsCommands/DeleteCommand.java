...
public class DeleteCommand implements SubCommandInterface {
    ...
    public boolean execute(CommandSender sender, String[] args) {
        if (args.length < 2) {
            Components.sendInfoMessage(sender, "Usage: /shops delete <name>");
            return true;
        }
        plugin.shopsService.deleteShop(sender, args[1]);
        return true;
    }
    ...
    @Override
    public String getPermission() { return "furious.shops.delete"; }
}
