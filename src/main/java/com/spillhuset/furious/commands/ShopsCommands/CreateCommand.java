...
public class CreateCommand implements SubCommandInterface {
    ...
    public boolean execute(CommandSender sender, String[] args) {
        if (args.length < 2) {
            Components.sendInfoMessage(sender, "Usage: /shops create <name>");
            return true;
        }
        plugin.shopsService.createShop(sender, args[1]);
        return true;
    }
    ...
    @Override
    public String getPermission() { return "furious.shops.create"; }
}
