...
public class UnclaimCommand implements SubCommandInterface {
    ...
    public boolean execute(CommandSender sender, String[] args) {
        if (args.length < 2) {
            Components.sendErrorMessage(sender, "Usage: /banks unclaim <bankName>");
            return true;
        }
        plugin.banksService.unclaimBank(sender, args[1]);
        return true;
    }
    ...
    @Override
    public String getPermission() { return "furious.banks.unclaim"; }
}
