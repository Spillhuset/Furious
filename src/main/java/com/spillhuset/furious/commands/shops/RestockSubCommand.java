...
/**
 * Subcommand for restocking all items in a shop.
 */
public class RestockSubCommand implements SubCommand {

    private final Furious plugin;
    private final ShopsManager shopsManager;

    /**
     * Constructor for RestockSubCommand.
     *
     * @param plugin The main plugin instance
     */
    public RestockSubCommand(Furious plugin) {
        this.plugin = plugin;
    ...
    public String getDescription() {
        return "Restock all items in a shop";
    }
    ...
    public boolean execute(@NotNull CommandSender sender, @NotNull String[] args) {
        ...
        // Restock the shop
        if (shopsManager.restockShop(shopName)) {
            sender.sendMessage("§aRestocked all items in shop §e" + shopName + "§a!");
            return true;
        } else {
            sender.sendMessage("§cFailed to restock shop!");
            return false;
        }
    }
    ...
    public List<String> tabComplete(CommandSender sender, @NotNull String[] args) {
        // No tab completions for restock
