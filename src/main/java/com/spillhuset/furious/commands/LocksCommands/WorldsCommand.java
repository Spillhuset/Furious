...
public class WorldsCommand implements SubCommandInterface {
    ...
    public List<String> tabComplete(CommandSender sender, String[] args) {
        // /locks worlds [world] [enable|disable]
    ...
    public boolean execute(CommandSender sender, String[] args) {
        ...
        if (args.length == 1) {
            plugin.locksService.listWorlds(sender);
            Components.sendInfoMessage(sender, "Usage: /locks worlds <world> <enable|disable>");
            return true;
        }
        if (args.length == 3) {
            ...
            plugin.locksService.setWorldEnabled(sender, world.getUID(), enable);
            return true;
        }
